...
[![PyPI version](https://img.shields.io/pypi/v/alphascope)](https://pypi.org/project/alphascope/)
[![Python](https://img.shields.io/pypi/pyversions/alphascope)](https://pypi.org/project/alphascope/)
...
```bash
git clone https://github.com/kyo219/alphascope.git
cd alphascope
uv sync --all-extras
```
...
# dist/ に以下が生成される
#   alphascope-X.Y.Z.tar.gz
#   alphascope-X.Y.Z-py3-none-any.whl
```
...
```bash
# バージョンを手動で上げる場合
# pyproject.toml と src/alphascope/__init__.py の version を更新
git tag v0.2.0
