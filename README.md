...
[![PyPI version](https://img.shields.io/pypi/v/alpharadar)](https://pypi.org/project/alpharadar/)
[![Python](https://img.shields.io/pypi/pyversions/alpharadar)](https://pypi.org/project/alpharadar/)
...
```bash
pip install alpharadar
```

開発用:

```bash
git clone https://github.com/kyo219/alpharadar.git
cd alpharadar
uv sync --all-extras
```
...
# dist/ に以下が生成される
#   alpharadar-X.Y.Z.tar.gz
#   alpharadar-X.Y.Z-py3-none-any.whl
```
...
```bash
# バージョンを手動で上げる場合
# pyproject.toml と src/alpharadar/__init__.py の version を更新
git tag v0.2.0
